...
logInForm.addEventListener("submit", function (e) {
    ...
    const authApi = "http://localhost:1000/auth/login"
...
function getCustomers(pageNo, rowsCount, sortBy) {
    ...
    const apiUrl = `http://localhost:1000/customer/getCustomers?pageNo=${pageNo}&rowsCount=${rowsCount}&sortBy=${sortBy}`;
...
addCustomerForm.addEventListener("submit", (e) => {
    ...
    const apiUrl = 'http://localhost:1000/customer/create?SyncDb=false';
...
function deleteCust(event) {
    ...
    const apiUrl = `http://localhost:1000/customer/delete?email=${email}`
...
function editRow(btn) {
    ...
    editCustomerForm.addEventListener("submit", function (e) {
        ...
        const authToken = localStorage.getItem('jwtToken');
        const apiUrl = `http://localhost:1000/customer/update/${personToupdate}`;
        fetch(apiUrl, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
...
function search() {
    ...
    const apiUrl = `http://localhost:1000/customer/searchBy?searchBy=${selectedValue}&searchQuery=${searchValue}`
...
function syncDB() {
    let customersSync = [];
    const apiUrl = `http://localhost:1000/customer/syncDB`
    ...
    fetch(apiUrl, {
        ...
        .then(data => {
            ...
            customersSync.forEach(customer => {
                ...
                const apiUrl = 'http://localhost:1000/customer/create?SyncDb=true';
